...
const handleAreaSelection = (area) => {
  ...
  const totalTickets = (formData.vipCount || 0) + (formData.regularCount || 0); // Beregn total billetter (VIP + Regular)
...
const onSubmit = async (data) => {
  ...
  const totalTickets = (formData.vipCount || 0) + (formData.regularCount || 0); //hvor pladser er der af hver, er der ingen gør vi værdien er 0, så den ikke er undefined og giver os problemer
